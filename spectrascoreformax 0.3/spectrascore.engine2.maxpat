...
, 			{
				"box" : 				{
					...
					"text" : "//available commands:\nopenWindow loopon loopoff play stop scoresize (int, int, int) newscore duration (int) newnote (int)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 178.0, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 141.5714111328125, 30.0, 30.0 ]
				}
...
, 			{
				"name" : "spectrascore.edit2.maxpat",
				"bootpath" : "/Users/Shared/Max 8/Packages/spectrascore",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
